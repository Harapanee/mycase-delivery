...
usage: python3 tools/append_batch.py --account ja|en --tag reels-v2 --from 2026-09-23T18:00 \
         <動画.mp4>:<テンプレート>:<サムネ秒> ...
"""
import datetime
import json
...
def main():
    ...
    for k, (spec, at) in enumerate(zip(specs, slots(acc, first))):
